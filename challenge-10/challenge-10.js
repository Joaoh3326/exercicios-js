(function () {
    ...
    */
    sum ? console.log(showOperationMessage( operationSignal, number1, number2 ), sum( number1, number2 )) 
    ...
    */
    ...
    subtraction ? console.log(showOperationMessage( operationSignal, number1, number2 ), subtraction( number1, number2 )) 
                : console.log(showErrorMessage( operationSignal ));

    operationSignal = '*';
    var multiplication = calculator( operationSignal );

    multiplication ? console.log(showOperationMessage( operationSignal, number1, number2 ), multiplication( number1, number2 )) 
                   : console.log(showErrorMessage( operationSignal ));

    operationSignal = '/';
    var division = calculator( operationSignal );

    division ? console.log(showOperationMessage( operationSignal, number1, number2 ), division( number1, number2 )) 
             : console.log(showErrorMessage( operationSignal ));

    operationSignal = '%';
    var mod = calculator( operationSignal );

    mod ? console.log(showOperationMessage( operationSignal, number1, number2 ), mod( number1, number2 )) 
        : console.log(showErrorMessage( operationSignal ));
    ...
    */
    ...
    error ? console.log(showOperationMessage( operationSignal, number1, number2 ), error( number1, number2 )) 
          : console.log(showErrorMessage( operationSignal ));
})();