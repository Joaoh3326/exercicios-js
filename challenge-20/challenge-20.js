(function(wind, doc) {
    ...
    */
    ...
    var arrInvalidos = [ "walter-da-silva@maraca.br", "rita-marica@titica.a.b", "agua_@evida.br.com" ];
    arrValidos.forEach( function( email ) {
        console.log( isValidEmail( email ) );
    } );

    arrInvalidos.forEach( function( email ) {
        console.log( isValidEmail( email ) );
    } );
})(window, document);