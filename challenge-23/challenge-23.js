(function(win, doc) {
  'use strict';
    ...
    */
    ...
    var $butttonsOperations = doc.querySelectorAll('[data-js="button-operation"]');
    ...
    Array.prototype.forEach.call($butttonsOperations, function(button) {
      button.addEventListener('click', handleClickOperation, false);
    });

    $buttonCE.addEventListener('click', handleClickCE, false);

    $buttonEqual.addEventListener('click', handeClickEqual, false);
